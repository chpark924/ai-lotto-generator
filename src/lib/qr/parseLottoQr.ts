...
// 정정(QA_LOG.md 35/36번 항목): 한때 "동행복권이 donghanglottery.com으로 개편됐다"고 보고
// 이 도메인도 허용하도록 넓혔었는데, 사용자가 실기기(한국 네트워크)에서 확인해보니
// donghanglottery.com은 한국 정부(방송통신심의위원회) 명령으로 Cloudflare가 "법적 사유"로
// 차단한 사이트였다 — 즉 진짜 동행복권과 무관한 가짜/불법 사이트일 가능성이 매우 높다.
